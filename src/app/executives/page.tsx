    ...
    return (
        <section className='flex-col' >
            ...
            <section className='flex-col p-0 m:0 sm:flex sm:mr-10 sm:ml-10 sm:p-40'>
                <Profile fullName='Aman  Purohit' profilePic='/executives/AP.png' role='President' pronouns='He/Him' description='I am the architect who drew up the plan for the club. I am also the President of the club. My pride and joy the Sheridan Swiftie Club is turning 1, we are working very hard in building this amazing community. Looking foarward to all the events and meetups we have planned this fall semester! ' />
